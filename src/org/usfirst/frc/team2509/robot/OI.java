...
public class OI {
	...
	public Thread UpdateDashboard = new Thread(()->{
		while(true) {
			...
			SmartDashboard.putNumber("Gyro Rate", Robot.drivetrain.getGyro().getRate());
			SmartDashboard.putNumber("Left", Robot.drivetrain.getLeft().get());
			SmartDashboard.putNumber("Right", Robot.drivetrain.getRight().get());
			SmartDashboard.putNumber("Lenc", Robot.drivetrain.getLeftEncoder().getRate());
			SmartDashboard.putNumber("Renc", Robot.drivetrain.getRightEncoder().getRate());
		}
	});
}
