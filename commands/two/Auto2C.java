...
/**
 *drives forward 45 inches, turns left, drives forward 95 inches, turns right, drives forward 65 inches
 * turns right, and drops the box into the switch
 */
public class Auto2C extends Command {
    ...
    protected void initialize() {
    	...
    	driveTrain.driveForward(95);//drives forward 95 inches
    	driveTrain.rotate(90);//turns right
    	driveTrain.driveForward(65);//drives forward 65 inches
    	driveTrain.rotate(90);//turns right
